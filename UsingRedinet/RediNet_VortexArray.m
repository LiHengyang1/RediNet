...
r0 = 6.25;
delta_D1 = 12 * lambda * f / L0 / 1;
delta_D2 = 12 * lambda * f / L0 / 1;
delta_D3 = -4;
...
imagetarget(28 + 2,28 + 2,28 + 3) = 1;
imagetarget(28 + 4,28 + 4,28 + 3) = 1.1;
imagetarget(28 + 8,28 + 8,28 + 3) = 1;
imagetarget(28 + 6,28 + 6,28 + 3) = 1.1;

imagetarget(28 + 3,28 + 7,28 + 2) = 1.2;
imagetarget(28 + 7,28 + 3,28 + 2) = 1.2;
