...
delta_D1 = 20 * lambda * f / L0 / 1;
delta_D2 = -1;
delta_D3 = -2;
differencephase_D1 = k * x / z * delta_D1;
differencephase_D2 = delta_D2 * theta;
...
imagetarget(28 + 2,28 + 3,28 + 4) = 0.7;
imagetarget(28 + 4,28 + 4,28 + 3) = 0.9;
imagetarget(28 + 6,28 + 6,28 + 1) = 1.2;
imagetarget(28 + 8,28 + 7,28 + 2) = 1.1;
