...
r0 = 6.25;
delta_D1 = 18 * lambda * f / L0 / 1;
delta_D2 = 1;
delta_D3 = 1;
differencephase_D1 = k * x / z * delta_D1;
differencephase_D2 = zeros(N);
differencephase_D2(r>ring3) = -pi;
...
imagetarget(28 + 3,28 + 5,28 + 7) = 1;
imagetarget(28 + 4,28 + 3,28 + 8) = 1;
imagetarget(28 + 6,28 + 8,28 + 8) = 1;
imagetarget(28 + 7,28 + 6,28 + 7) = 1;
...
mappingSpace1 = circshift(mappingSpace1,15,3);               %trick
...
lagaierComp = ones(N) * pi;
lagaierComp(r>ring1) = 0;
lagaierComp(r>ring2) = pi;
lagaierComp = exp(1i * lagaierComp);
finalphase = finalphase .* lagaierComp;
figure;
